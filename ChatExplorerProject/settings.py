"""
Django settings for ChatExplorerProject project.
...
SECRET_KEY = 'django-insecure-8#*9nb&3*d1w4_lazfly4#8x*(z$fmr3m(+m#@9ij)5wk47_95'
...
MEDIA_URL='/media/'
MEDIA_ROOT=os.path.join(BASE_DIR,'adsportal/media')
